...
import { purchaseProduct } from '@/services/billing/billingService';
...
export default function PaywallScreen() {
  ...
  const handlePurchase = useCallback(async () => {
    ...
    setError(null);
    try {
      await purchaseProduct(selectedId);
      await refreshCustomerInfo();
      router.back();
    } catch (e: any) {
      // User cancellation codes from react-native-iap
      if (e?.code === 'E_USER_CANCELLED' || e?.code === 'E_ITEM_UNAVAILABLE') {
