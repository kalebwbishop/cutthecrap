...
**Run date:** 2026-03-25T13:56:56.281Z
**Summary:** 39 passed, 6 failed, 1 warnings, 38 manual

## ❌ Failures

These must be fixed before submitting to Google Play.

### App Build — Version code is set

android.versionCode is missing from app.json — required by Google Play
